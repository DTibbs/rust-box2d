...
fn setup_box2d() -> World {
    ...
    // Let's make a circle with a 20cm radius
    let circle_shape = CircleShape {
                            center: Vec2::new(0.0, 0.0),
                            radius: 0.20
                        };
    let circle_body_def = BodyDef {
                            shape: circle_shape,
    ...
    let chain_line_shape = ChainLineShape {
                            points: vec! [
                                Vec2::new(-3.0, -1.5),
                                Vec2::new(-3.0, 0.0),
                                Vec2::new(3.0, 0.5),
    ...
    let chain_line_body_def = BodyDef {
                            shape: chain_line_shape,
